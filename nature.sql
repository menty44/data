...
--
-- Table structure for table `nt_assets`
--

CREATE TABLE IF NOT EXISTS `nt_assets` (
...
--
-- Dumping data for table `nt_assets`
--

INSERT INTO `nt_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Table structure for table `nt_associations`
--

CREATE TABLE IF NOT EXISTS `nt_associations` (
...
--
-- Table structure for table `nt_banners`
--

CREATE TABLE IF NOT EXISTS `nt_banners` (
...
--
-- Table structure for table `nt_banner_clients`
--

CREATE TABLE IF NOT EXISTS `nt_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `nt_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `nt_banner_tracks` (
...
--
-- Table structure for table `nt_categories`
--

CREATE TABLE IF NOT EXISTS `nt_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `nt_categories`
--

INSERT INTO `nt_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
--
-- Table structure for table `nt_commentmeta`
--

CREATE TABLE IF NOT EXISTS `nt_commentmeta` (
...
--
-- Table structure for table `nt_comments`
--

CREATE TABLE IF NOT EXISTS `nt_comments` (
...
--
-- Dumping data for table `nt_comments`
--
...
(1, 1, 'Mr WordPress', '', 'https://wordpress.org/', '', '2015-07-18 09:34:50', '2015-07-18 09:34:50', 'Hi, this is a comment.\nTo delete a comment, just log in and view the post&#039;s comments. There you will have the option to edit or delete them.', 0, '1', '', '', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `nt_contact_details`
--

CREATE TABLE IF NOT EXISTS `nt_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `nt_content`
--

CREATE TABLE IF NOT EXISTS `nt_content` (
...
--
-- Table structure for table `nt_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `nt_contentitem_tag_map` (
...
--
-- Table structure for table `nt_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `nt_content_frontpage` (
...
--
-- Table structure for table `nt_content_rating`
--

CREATE TABLE IF NOT EXISTS `nt_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `nt_content_types`
--

CREATE TABLE IF NOT EXISTS `nt_content_types` (
...
--
-- Dumping data for table `nt_content_types`
--

INSERT INTO `nt_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `nt_links`
--

CREATE TABLE IF NOT EXISTS `nt_links` (
...
--
-- Table structure for table `nt_options`
--
...
--
-- Table structure for table `nt_postmeta`
--

CREATE TABLE IF NOT EXISTS `nt_postmeta` (
  `meta_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `nt_postmeta`
--
...
--
-- Table structure for table `nt_posts`
--
...
--
-- Dumping data for table `nt_posts`
--

INSERT INTO `nt_posts` (`ID`, `post_author`, `post_date`, `post_date_gmt`, `post_content`, `post_title`, `post_excerpt`, `post_status`, `comment_status`, `ping_status`, `post_password`, `post_name`, `to_ping`, `pinged`, `post_modified`, `post_modified_gmt`, `post_content_filtered`, `post_parent`, `guid`, `menu_order`, `post_type`, `post_mime_type`, `comment_count`) VALUES
(1, 1, '2015-07-18 09:34:50', '2015-07-18 09:34:50', 'Welcome to WordPress. This is your first post. Edit or delete it, then start blogging!', 'Hello world!', '', 'publish', 'open', 'open', '', 'hello-world', '', '', '2015-07-18 09:34:50', '2015-07-18 09:34:50', '', 0, 'http://localhost/wordpress/?p=1', 0, 'post', '', 1),
(2, 1, '2015-07-18 09:34:50', '2015-07-18 09:34:50', 'This is an example page. It''s different from a blog post because it will stay in one place and will show up in your site navigation (in most themes). Most people start with an About page that introduces them to potential site visitors. It might say something like this:\n\n<blockquote>Hi there! I''m a bike messenger by day, aspiring actor by night, and this is my blog. I live in Montreal, have a great dog named Jack, and I like pi&#241;a coladas. (And gettin'' caught in the rain.)</blockquote>\n\n...or something like this:\n\n<blockquote>The XYZ Doohickey Company was founded in 1971, and has been providing quality doohickeys to the public ever since. Located in Gotham City, XYZ employs over 2,000 people and does all kinds of awesome things for the Gotham community.</blockquote>\n\nAs a new WordPress user, you should go to <a href="http://localhost/wordpress/wp-admin/">your dashboard</a> to delete this page and create new pages for your content. Have fun!', 'Sample Page', '', 'publish', 'open', 'open', '', 'sample-page', '', '', '2015-07-18 09:34:50', '2015-07-18 09:34:50', '', 0, 'http://localhost/wordpress/?page_id=2', 0, 'page', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `nt_terms`
--

CREATE TABLE IF NOT EXISTS `nt_terms` (
...
--
-- Dumping data for table `nt_terms`
--
...
--
-- Table structure for table `nt_term_relationships`
--

CREATE TABLE IF NOT EXISTS `nt_term_relationships` (
...
--
-- Dumping data for table `nt_term_relationships`
--
...
--
-- Table structure for table `nt_term_taxonomy`
--

CREATE TABLE IF NOT EXISTS `nt_term_taxonomy` (
...
--
-- Dumping data for table `nt_term_taxonomy`
--
...
--
-- Table structure for table `nt_usermeta`
--

CREATE TABLE IF NOT EXISTS `nt_usermeta` (
...
--
-- Dumping data for table `nt_usermeta`
--
...
(10, 1, 'nt_capabilities', 'a:1:{s:13:"administrator";b:1;}'),
(11, 1, 'nt_user_level', '10'),
...
(1, 'root', '$P$BcK4xV2JaMS6EbmfLYK3uRZD1bx/Sg0', 'root', 'waitherarose50@gmail.com', '', '2015-07-18 09:34:48', '', 0, 'root');
